...
describe("HelpRequestIndexPage tests", () => {
    ...
    test("renders help requests without crashing for admin user", async () => {
        setupAdminUser();
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/helprequest/all").reply(200, helpRequestFixtures.threeHelpRequests);
    ...
    test("test what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/helprequest/all").reply(200, helpRequestFixtures.threeHelpRequests);
        axiosMock.onDelete("/api/helprequest", {params: {id: 1}}).reply(200, "Help Request with id 1 was deleted");
