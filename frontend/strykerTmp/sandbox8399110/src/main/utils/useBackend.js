      ...
      if (stryMutAct_9fa48("669")) {
        ...
        try {
          ...
          if (stryMutAct_9fa48("671")) {
            ...
            if (stryMutAct_9fa48("673") ? false : stryMutAct_9fa48("672") ? true : (stryCov_9fa48("672", "673"), e.response?.data?.message)) {
              ...
              if (stryMutAct_9fa48("677")) {
                ...
                stryCov_9fa48("677");
                const errorMessage = stryMutAct_9fa48("678") ? `` : (stryCov_9fa48("678"), `Error communicating with backend via ${axiosParameters.method} on ${axiosParameters.url}`);
...
export function useBackendMutation(objectToAxiosParams, useMutationParams, queryKey = null) {
  if (stryMutAct_9fa48("681")) {
    ...
    return useMutation(stryMutAct_9fa48("682") ? () => undefined : (stryCov_9fa48("682"), object => wrappedParams(objectToAxiosParams(object))), stryMutAct_9fa48("683") ? {} : (stryCov_9fa48("683"), {
      onError: error => {
        if (stryMutAct_9fa48("684")) {
          ...
          if (stryMutAct_9fa48("686") ? false : stryMutAct_9fa48("685") ? true : (stryCov_9fa48("685", "686"), error.response?.data?.message)) {
            ...
            if (stryMutAct_9fa48("690")) {
              ...
              stryCov_9fa48("690");
              const errorMessage = stryMutAct_9fa48("691") ? `` : (stryCov_9fa48("691"), `Error communicating with backend via ${error.response.config.method} on ${error.response.config.url}`);
              toast.error(errorMessage);
            }
          }
        }
