...
export default function OrganizationIndexPage() {
  if (stryMutAct_9fa48("511")) {
    ...
    ["/api/ucsborganization/all"], // Stryker disable next-line StringLiteral,ObjectLiteral : since "GET" is default, "" is an equivalent mutation
    {
      method: "GET",
      url: "/api/ucsborganization/all"
    }, stryMutAct_9fa48("517") ? ["Stryker was here"] : (stryCov_9fa48("517"), []));
    return <BasicLayout>
      <div className="pt-2">
