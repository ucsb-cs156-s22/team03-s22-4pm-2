...
export default function RecommendationIndexPage() {
  if (stryMutAct_9fa48("526")) {
    ...
    ["/api/recommendation/all"], // Stryker disable next-line StringLiteral,ObjectLiteral : since "GET" is default, "" is an equivalent mutation
    {
      method: "GET",
      url: "/api/recommendation/all"
    }, stryMutAct_9fa48("532") ? ["Stryker was here"] : (stryCov_9fa48("532"), []));
    return <BasicLayout>
      <div className="pt-2">
