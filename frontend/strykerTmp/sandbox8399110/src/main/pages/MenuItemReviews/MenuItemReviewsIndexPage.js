...
export default function MenuItemReviewIndexPage() {
  if (stryMutAct_9fa48("504")) {
    ...
    const {
      ...
      error: _error,
      status: _status
    } = useBackend(stryMutAct_9fa48("505") ? [] : (stryCov_9fa48("505"), [stryMutAct_9fa48("506") ? "" : (stryCov_9fa48("506"), "/api/MenuItemReview/all")]), stryMutAct_9fa48("507") ? {} : (stryCov_9fa48("507"), {
      method: stryMutAct_9fa48("508") ? "" : (stryCov_9fa48("508"), "GET"),
      url: stryMutAct_9fa48("509") ? "" : (stryCov_9fa48("509"), "/api/MenuItemReview/all")
