...
export default function MenuItemReviewIndexPage() {
  if (stryMutAct_9fa48("499")) {
    ...
    ["/api/MenuItemReview/all"], // Stryker disable next-line StringLiteral,ObjectLiteral : since "GET" is default, "" is an equivalent mutation
    {
      method: "GET",
      url: "/api/MenuItemReview/all"
    }, stryMutAct_9fa48("505") ? ["Stryker was here"] : (stryCov_9fa48("505"), []));
    return <BasicLayout>
      <div className="pt-2">
